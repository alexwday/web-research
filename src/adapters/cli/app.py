...
from src.infra._database import get_database, reset_database
from src.config.settings import load_config, get_env_settings, set_config
from src.infra.llm import get_llm_client
from src.config.logger import print_header, print_info, print_error, print_success, print_statistics_table
...
def mcp_serve():
    ...
    from src.adapters.mcp import mcp as mcp_server
    mcp_server.run()
